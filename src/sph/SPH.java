...
public class SPH {
	...
	private float rho = 1;
	private float m = (float) 0.0003;
	private float c = 100;
	private float gamma = 7;
	...
	public void set_rho(float rho) {
		this.rho = rho;
		System.out.println("setting rho to: " + rho);
	...
	public void set_c(float c) {
		this.c = c;
		System.out.println("setting c to: " + c);
	...
	public void set_gamma(float gamma) {
		this.gamma = gamma;
		System.out.println("setting gamma to: " + gamma);
